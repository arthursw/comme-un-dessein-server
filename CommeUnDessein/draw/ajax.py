...
def autoTrace(request, png, colors):
	...
	try:
		...
		# eroded_data_image = Image.fromarray(eroded_data.astype(np.uint8))
		# eroded2_data_image = Image.fromarray(eroded2_data.astype(np.uint8))
		# eroded_data_image = eroded_data_image.convert('1')
		# eroded_data_image.save('CommeUnDessein/media/eroded_data_image.bmp', 'BMP')
		# eroded2_data_image = eroded2_data_image.convert('1')
		# eroded2_data_image.save('CommeUnDessein/media/eroded2_data_image.bmp', 'BMP')
